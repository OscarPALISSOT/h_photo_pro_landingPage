...
require get_template_directory() . '/include/menu-functions.php';
...
// Block Patterns.
require get_template_directory() . '/include/block-patterns.php';

// Block Styles.
require get_template_directory() . '/include/block-styles.php';
